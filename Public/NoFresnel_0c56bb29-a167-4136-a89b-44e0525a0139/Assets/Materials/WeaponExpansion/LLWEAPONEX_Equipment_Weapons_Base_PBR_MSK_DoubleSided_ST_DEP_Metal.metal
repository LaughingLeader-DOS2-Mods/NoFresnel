...
vertex VertexOutput WeaponExpansion_LLWEAPONEX_Equipment_Weapons_Base_PBR_MSK_DoubleSided_ST_DEP_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
