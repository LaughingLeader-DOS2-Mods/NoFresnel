...
vertex VertexOutput WeaponExpansion_LLWEAPONEX_Base_Characters_PBR_GM_MagicWall_01_STI_SHA_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_LLWEAPONEX_Base_Characters_PBR_GM_MagicWall_01_STI_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]])
{
	PixelOutput Out;
