...
vertex VertexOutput WeaponExpansion_WPN_LLWEAPONEX_Runeblade_Unique_ChaosEdge_PBR_ST_FOR_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_WPN_LLWEAPONEX_Runeblade_Unique_ChaosEdge_PBR_ST_FOR_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
