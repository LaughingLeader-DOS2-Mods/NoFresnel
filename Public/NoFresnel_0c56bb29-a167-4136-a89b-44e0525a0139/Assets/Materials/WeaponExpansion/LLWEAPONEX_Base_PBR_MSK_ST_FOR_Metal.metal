...
vertex VertexOutput WeaponExpansion_LLWEAPONEX_Base_PBR_MSK_ST_FOR_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_LLWEAPONEX_Base_PBR_MSK_ST_FOR_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
