...
vertex VertexOutput WeaponExpansion_LLWEAPONEX_Weapon_PBR_Base_MSK_STI_FOR_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_LLWEAPONEX_Weapon_PBR_Base_MSK_STI_FOR_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
