...
vertex VertexOutput WeaponExpansion_LLWEAPONEX_PBR_Base_AlphaTest_CustomMSK_ST_FOR_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_LLWEAPONEX_PBR_Base_AlphaTest_CustomMSK_ST_FOR_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
