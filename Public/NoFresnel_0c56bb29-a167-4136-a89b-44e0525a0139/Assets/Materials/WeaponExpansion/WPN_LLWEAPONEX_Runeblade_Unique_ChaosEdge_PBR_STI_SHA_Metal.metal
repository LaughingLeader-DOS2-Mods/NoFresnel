...
vertex VertexOutput WeaponExpansion_WPN_LLWEAPONEX_Runeblade_Unique_ChaosEdge_PBR_STI_SHA_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_WPN_LLWEAPONEX_Runeblade_Unique_ChaosEdge_PBR_STI_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]])
{
	PixelOutput Out;
