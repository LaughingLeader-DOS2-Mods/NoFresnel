...
vertex VertexOutput WeaponExpansion_LLWEAPONEX_PBR_Characters_Base_SK_SHA_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_LLWEAPONEX_PBR_Characters_Base_SK_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]])
{
	PixelOutput Out;
