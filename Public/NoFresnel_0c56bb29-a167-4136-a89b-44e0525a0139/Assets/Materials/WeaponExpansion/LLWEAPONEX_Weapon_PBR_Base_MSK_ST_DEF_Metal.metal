...
vertex VertexOutput WeaponExpansion_LLWEAPONEX_Weapon_PBR_Base_MSK_ST_DEF_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_LLWEAPONEX_Weapon_PBR_Base_MSK_ST_DEF_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
