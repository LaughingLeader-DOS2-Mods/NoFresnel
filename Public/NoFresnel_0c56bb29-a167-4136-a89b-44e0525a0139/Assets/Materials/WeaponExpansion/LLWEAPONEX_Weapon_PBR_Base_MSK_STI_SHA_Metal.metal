...
vertex VertexOutput WeaponExpansion_LLWEAPONEX_Weapon_PBR_Base_MSK_STI_SHA_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_LLWEAPONEX_Weapon_PBR_Base_MSK_STI_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]])
{
	PixelOutput Out;
