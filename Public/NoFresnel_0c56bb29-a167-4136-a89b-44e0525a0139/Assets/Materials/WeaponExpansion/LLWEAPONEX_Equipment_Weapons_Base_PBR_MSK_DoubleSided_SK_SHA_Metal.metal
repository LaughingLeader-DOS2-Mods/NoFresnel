...
vertex VertexOutput WeaponExpansion_LLWEAPONEX_Equipment_Weapons_Base_PBR_MSK_DoubleSided_SK_SHA_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_LLWEAPONEX_Equipment_Weapons_Base_PBR_MSK_DoubleSided_SK_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]])
{
	PixelOutput Out;
