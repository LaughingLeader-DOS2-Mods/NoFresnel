...
vertex VertexOutput WeaponExpansion_WPN_LLWEAPONEX_Runeblade_Unique_ChaosEdge_PBR_STI_DEF_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_WPN_LLWEAPONEX_Runeblade_Unique_ChaosEdge_PBR_STI_DEF_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
