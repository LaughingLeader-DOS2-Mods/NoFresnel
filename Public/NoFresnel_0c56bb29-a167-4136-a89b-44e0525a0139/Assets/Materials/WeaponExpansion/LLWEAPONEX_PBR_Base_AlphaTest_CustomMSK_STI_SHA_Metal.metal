...
vertex VertexOutput WeaponExpansion_LLWEAPONEX_PBR_Base_AlphaTest_CustomMSK_STI_SHA_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_LLWEAPONEX_PBR_Base_AlphaTest_CustomMSK_STI_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]],
	sampler _DefaultWrapSampler,
	texture2d<float> Texture2DParameter_basecolor_DefaultWrapSampler)
{
	PixelOutput Out;
