...
vertex VertexOutput WeaponExpansion_LLWEAPONEX_PBR_Base_AlphaTest_CustomMSK_STI_DEF_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput WeaponExpansion_LLWEAPONEX_PBR_Base_AlphaTest_CustomMSK_STI_DEF_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
