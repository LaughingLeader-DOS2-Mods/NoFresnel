...
vertex VertexOutput Equipment_Weapons_Equipment_Weapons_Base_PBR_MSK_AlphaTest_ST_SHA_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Equipment_Weapons_Equipment_Weapons_Base_PBR_MSK_AlphaTest_ST_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]],
	sampler _DefaultWrapSampler,
	texture2d<float> Texture2DParameter_basecolor_DefaultWrapSampler)
{
	PixelOutput Out;
