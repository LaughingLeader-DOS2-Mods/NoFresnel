...
vertex VertexOutput Equipment_Weapons_Equipment_Weapons_Base_PBR_MSK_Reflectance_SK_SHA_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Equipment_Weapons_Equipment_Weapons_Base_PBR_MSK_Reflectance_SK_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]])
{
	PixelOutput Out;
