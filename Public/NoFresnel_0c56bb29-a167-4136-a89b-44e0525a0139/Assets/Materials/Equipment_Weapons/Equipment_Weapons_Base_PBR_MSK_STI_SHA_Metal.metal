...
vertex VertexOutput Equipment_Weapons_Equipment_Weapons_Base_PBR_MSK_STI_SHA_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput Equipment_Weapons_Equipment_Weapons_Base_PBR_MSK_STI_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]])
{
	PixelOutput Out;
