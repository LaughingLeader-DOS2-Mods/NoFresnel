...
vertex VertexOutput Characters_PBR_Characters_PBR_Base_STI_DEF_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput Characters_PBR_Characters_PBR_Base_STI_DEF_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
