...
vertex VertexOutput Characters_PBR_Characters_PBR_Anisotropic_AlphaTest_SK_DEF_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Characters_PBR_Characters_PBR_Anisotropic_AlphaTest_SK_DEF_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
