...
vertex VertexOutput Characters_PBR_Characters_PRB_Skeletons_ST_DEF_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Characters_PBR_Characters_PRB_Skeletons_ST_DEF_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
	...
	texture2d<float> Texture2DParameter_physicalmap_DefaultWrapSampler)
{
	...
	float3 matBaseColor;
	CalculateMatBaseColor(uniforms, In.TexCoords0, matBaseColor, _DefaultWrapSampler, Texture2DParameter_MSKskin_DefaultWrapSampler, Texture2DParameter_basecolor_DefaultWrapSampler, Texture2DParameter_MSKcloth_DefaultWrapSampler);
	float matMetalMask;
