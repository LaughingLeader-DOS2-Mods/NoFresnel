...
vertex VertexOutput Characters_PBR_Characters_PRB_Skeletons_STI_FOR_Metal_vertexMain(constant PerView& perView [[buffer(5)]],
...
fragment PixelOutput Characters_PBR_Characters_PRB_Skeletons_STI_FOR_Metal_fragmentMain(constant LocalUniformsPS& uniforms,
