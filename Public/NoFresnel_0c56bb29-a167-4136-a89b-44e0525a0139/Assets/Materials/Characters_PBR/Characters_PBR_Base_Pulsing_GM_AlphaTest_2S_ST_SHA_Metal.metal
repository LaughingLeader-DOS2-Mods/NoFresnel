...
vertex VertexOutput Characters_PBR_Characters_PBR_Base_Pulsing_GM_AlphaTest_2S_ST_SHA_Metal_vertexMain(constant LocalUniformsVS& uniforms [[buffer(5)]],
...
fragment PixelOutput Characters_PBR_Characters_PBR_Base_Pulsing_GM_AlphaTest_2S_ST_SHA_Metal_fragmentMain(VertexOutput In [[stage_in]],
	sampler _DefaultWrapSampler,
	texture2d<float> Texture2DParameter_basecolor_DefaultWrapSampler)
{
	PixelOutput Out;
